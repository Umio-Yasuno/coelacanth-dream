...
ただ、GPU として高い性能を持つ **RX 6800 Series** は、従来の AMD GPU より性能に余裕があると思われ、*SAM* の効果は出やすい。  
*SAM* と **RX 6800 Series** と同時に発表したことは、**RX 6800 Series** が AMD にとって久しぶり (らしい) のハイエンド GPU というのもあるだろう。  
...
組み合わせというより、**RX 560 (Polairs11)** のようなエントリー向け GPU では多くで効果が見られない。上と関連して、GPU性能に余裕がある状況が少ない。  
ならば、GPU性能に余裕があれば CPU によらず効果があるとも考えられる。  
